...
Six tables are generated from a recorded run and a test fails when they drift: the
three sweep tables, the feature ablation, blocking recall and the volume
comparison. Four are not - the classifier comparison and three Abt-Buy tables are
